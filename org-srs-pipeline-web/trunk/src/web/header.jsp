...
<table class="pageHeader">
   ...
   <tr>
      ...
      <td align="right" valign="top">
         <a href="releasenotes.jsp">Version 2.5.1-SNAPSHOT</a>
         |
   ...
   <tr>
      <td align="right" valign="bottom">
         ...
         <p><a href="index.jsp">Task List</a>&nbsp;.&nbsp;<a href="logViewer.jsp">Message Viewer</a>&nbsp;.&nbsp;<a href="JobProcessingStats.jsp">Usage Plots</a>&nbsp;.&nbsp;<a href="batchShares.jsp">Fair Share Plots</a>&nbsp;.&nbsp;<a href="admin.jsp?login=true">Pipeline Admin</a></p>
      </td>  
   </tr>
</table>
