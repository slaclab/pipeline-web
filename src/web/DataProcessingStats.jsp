...
<c:if test="${debug == 0}">
    <sql:query var="data">
            ...
            (case when
               (dv.registered>'06-NOV-22 02:00' and dv.registered<'12-MAR-23 02:00') or
               (dv.registered>'07-NOV-21 02:00' and dv.registered<'13-MAR-22 02:00') or
               (dv.registered>'01-NOV-20 02:00' and dv.registered<'14-MAR-21 02:00') or
