    ...
    <tr>
        <td align="right" valign="bottom">
            <table>
                ...
                <tr>
                    <td align="right">
                        <login:login useQueryString="true"/> Mode: [ <srs_utils:modeChooser mode="dataSource" href="redirectToIndex.jsp"/> ]  <c:if test="${ ! empty userName }"><srs_utils:conditonalLink url="myPreferences.jsp" name="Preferences" /></c:if>
                    </td>
                </tr>
                <tr>
                    <td align="right">
